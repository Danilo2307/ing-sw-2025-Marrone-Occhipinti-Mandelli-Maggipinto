...
public class CardFactory {
    ...
    public static ArrayList<Card> generateLevel1Cards() {
        ...
        // warzone
        cardsOne.add(new CombatZone(1,3,0,2, List.of(Challenge.Members, Challenge.EngineStrength, Challenge.CannonStrength), List.of(new CannonShot(false, Direction.DOWN), new CannonShot(true, Direction.DOWN))));
    ...
    public static ArrayList<Card> generateLevel2Cards() {
        ...
        // combatzone
        cardsTwo.add(new CombatZone(2,4,3,0, List.of(Challenge.CannonStrength, Challenge.EngineStrength, Challenge.Members), List.of(new CannonShot(false, Direction.UP), new CannonShot(false, Direction.LEFT), new CannonShot(false, Direction.RIGHT), new CannonShot(true, Direction.DOWN))));
