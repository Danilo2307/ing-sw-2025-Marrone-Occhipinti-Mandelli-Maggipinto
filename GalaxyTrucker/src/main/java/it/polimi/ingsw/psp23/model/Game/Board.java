...
public class Board {
    ...
    public int calculateExposedConnectors() {
        ...
        for (int j = 0; j < cols; j++) {
            for (int i = 0; i < rows; i++) {
                if (isValid(i, j) && !isFree(i,j)) {
                    if (ship[i][j].getUp().equals(Side.SINGLE_CONNECTOR) || ship[i][j].getUp().equals(Side.DOUBLE_CONNECTOR) || ship[i][j].getUp().equals(Side.SHIELD_SINGLE_CONNECTOR) || ship[i][j].getUp().equals(Side.SHIELD_DOUBLE_CONNECTOR) || ship[i][j].getRight().equals(Side.UNIVERSAL_CONNECTOR)) {
                        count++;
                    }
                    break;
                }
        ...
        for (int j = 0; j < cols; j++) {
            for (int i = rows - 1; i >= 0; i--) {
                if (isValid(i, j) && !isFree(i,j)) {
                    if (ship[i][j].getDown().equals(Side.SINGLE_CONNECTOR) || ship[i][j].getDown().equals(Side.DOUBLE_CONNECTOR) || ship[i][j].getDown().equals(Side.SHIELD_SINGLE_CONNECTOR) || ship[i][j].getDown().equals(Side.SHIELD_DOUBLE_CONNECTOR) || ship[i][j].getRight().equals(Side.UNIVERSAL_CONNECTOR)) {
                        count++;
                    }
                    break;
                }
        ...
        for (int i = 0; i < rows; i++) {
            for (int j = 0; j < cols; j++) {
                if (isValid(i, j) && !isFree(i,j)) {
                    if (ship[i][j].getLeft().equals(Side.SINGLE_CONNECTOR) || ship[i][j].getLeft().equals(Side.DOUBLE_CONNECTOR) || ship[i][j].getLeft().equals(Side.SHIELD_SINGLE_CONNECTOR) || ship[i][j].getLeft().equals(Side.SHIELD_DOUBLE_CONNECTOR) || ship[i][j].getRight().equals(Side.UNIVERSAL_CONNECTOR)) {
                        count++;
                    }
                    break;
                }
