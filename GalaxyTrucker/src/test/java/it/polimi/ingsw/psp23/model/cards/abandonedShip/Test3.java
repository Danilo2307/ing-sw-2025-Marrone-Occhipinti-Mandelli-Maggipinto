...
public class Test3 {
    ...
    // Silently ignore RMI registry errors in tests
        ...
        AlienAddOns a1 = new AlienAddOns(Side.UNIVERSAL_CONNECTOR, Side.UNIVERSAL_CONNECTOR, Side.UNIVERSAL_CONNECTOR, Side.UNIVERSAL_CONNECTOR, Color.Purple,1);
        AlienAddOns a2 = new AlienAddOns(Side.UNIVERSAL_CONNECTOR, Side.UNIVERSAL_CONNECTOR, Side.UNIVERSAL_CONNECTOR, Side.UNIVERSAL_CONNECTOR, Color.Brown,1);
