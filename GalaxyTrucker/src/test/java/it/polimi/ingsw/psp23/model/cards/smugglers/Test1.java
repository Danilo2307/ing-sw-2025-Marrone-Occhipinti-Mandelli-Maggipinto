...
public class Test1 {
    ...
    void setUp() {
        ...
        caa1.moveToHand();
        p1.getTruck().addComponent(caa1, 4, 3);
        ...
        Cannon caf3 = new Cannon(Side.UNIVERSAL_CONNECTOR, Side.GUN, Side.UNIVERSAL_CONNECTOR, Side.UNIVERSAL_CONNECTOR, true);
        caf3.moveToHand();
        ...
        bf2.moveToHand();
        p2.getTruck().addComponent(bf2, 1, 4);
        ...
        cg1.moveToHand();
        p3.getTruck().addComponent(cf1, 2, 4);
