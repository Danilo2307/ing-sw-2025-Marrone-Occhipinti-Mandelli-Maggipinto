...
public class Test1 {
    ...
    // Silently ignore RMI registry errors in tests
        ...
        card = new MeteorSwarm(1, List.of(new Meteor(false, Direction.UP), new Meteor(false, Direction.UP), new Meteor(false, Direction.LEFT), new Meteor(false, Direction.RIGHT), new Meteor(false, Direction.DOWN)),1);
    }
    ...
    void testMeteorSwarm() throws CardException, InvocationTargetException, IllegalAccessException {
        ...
        String expected = "è uscita la carta Meteor Swarm\n" +
                ...
                card.getMeteors().toString() + "\n";
        String resultToStringMeteorSwarm = card.toString();
